...
import {
  ...
  focusGlobalAuditFiltersOnQaEvent,
...
describe("focusGlobalAuditFiltersOnQaEvent", () => {
  it("focuses global audit search on one QA audit event and clears stale filters", () => {
    const filters = {
      eventType: "scoring.completed",
      actorId: "risk-engine",
      runId: "scoring_CLM-1",
      claimId: "CLM-OLD",
      feedbackId: "qa_feedback_OLD",
      qaCaseId: "QA-OLD",
      sampleId: "sample_old",
      agentRunId: "agent_1",
      ruleId: "rule_early_claim",
    ...
    expect(
      focusGlobalAuditFiltersOnQaEvent(filters, {
        audit_id: "audit_qa_status_1",
        run_id: "qa_feedback_status_qa_feedback_QA-1",
      ...
      actorId: "qa-lead",
      runId: "qa_feedback_status_qa_feedback_QA-1",
      claimId: "CLM-1",
      feedbackId: "qa_feedback_QA-1",
      qaCaseId: "QA-1",
      sampleId: "sample_1",
