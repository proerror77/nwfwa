...
impl From<ProviderRelationshipGraphPayload> for ProviderRelationshipGraphInput {
    fn from(value: ProviderRelationshipGraphPayload) -> Self {
        Self {
            ...
            referral_concentration_entropy: value.referral_concentration_entropy,
            temporal_co_billing_score: value.temporal_co_billing_score,
            temporal_co_billing_frequency_7d: value.temporal_co_billing_frequency_7d,
            billing_ring_membership: value.billing_ring_membership,
