    ...
    json!({
        ...
        "ScoringFeatureContextMaterialization": {
            ...
            "properties": {
                ...
                "source_uris": {
                    "type": "object",
                    "required": ["claims_uri", "episode_rollups_uri", "peer_benchmarks_uri", "clinical_compatibility_uri", "unbundling_candidates_uri"]
                },
                ...
                "evidence_refs": {
                    "type": "array",
                    "items": { "type": "string" },
                    "description": "Must include scoring_feature_contexts:{report_uri}, episode_rollups:{episode_rollups_uri}, peer_benchmarks:{peer_benchmarks_uri}, clinical_compatibility:{clinical_compatibility_uri}, and unbundling_candidates:{unbundling_candidates_uri}."
                },
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "required_permission": {
                                ...
                                "minLength": 1,
                                "description": "API permission scope required before submitting this job artifact; null for artifact-only jobs. When api_path is supplied, this scope must match the endpoint family."
                            }
                        }
                    }
                },
