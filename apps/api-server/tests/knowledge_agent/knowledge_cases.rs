...
async fn publishes_confirmed_knowledge_case_for_similarity_and_audit() {
    ...
    let (status, body) = json_request(
        ...
        "/api/v1/ops/knowledge/cases",
        r#"{
          "case_id": "KC-LOOPBACK-EVIDENCE",
          "title": "Loopback evidence case",
          "fwa_type": "Waste",
          "scheme_family": "lab_overuse",
          "diagnosis_code": "E11",
          "provider_region": "Guangzhou",
          ...
          "outcome": "Confirmed waste.",
          "tags": ["lab_overuse"],
          "evidence_refs": ["investigation_results:INV-KB-LOOPBACK", "knowledge_cases:http://0.0.0.0:8080/case.json"],
          "source_claim_id": "CLM-KB-1"
        }"#,
    )
    .await;
    ...
    let (status, body) = json_request(
        ...
        "/api/v1/ops/knowledge/cases",
        r#"{
          "case_id": "KC-FILE-EVIDENCE",
          "title": "File evidence case",
          "fwa_type": "Waste",
          "scheme_family": "lab_overuse",
          "diagnosis_code": "E11",
          "provider_region": "Guangzhou",
          ...
          "outcome": "Confirmed waste.",
          "tags": ["lab_overuse"],
          "evidence_refs": ["investigation_results:INV-KB-FILE", "knowledge_cases:file://tmp/case.json"],
          "source_claim_id": "CLM-KB-1"
        }"#,
    )
    .await;
