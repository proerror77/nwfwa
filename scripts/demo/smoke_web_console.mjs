...
async function main() {
  ...
  try {
    ...
    assertContains(builtText, "Risk Operations", "web console navigation bundle");
    assertContains(builtText, "Review Queues", "web console navigation bundle");
    assertContains(builtText, "Detection Controls", "web console navigation bundle");
    assertContains(builtText, "Evidence & Context", "web console navigation bundle");
    assertContains(builtText, "Pilot Governance", "web console navigation bundle");
    assertContains(builtText, "Real-time operations", "web console workspace bundle");
    assertContains(builtText, "Search claim / case / provider / evidence", "web console workspace bundle");
