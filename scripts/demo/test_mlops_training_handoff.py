...
def provider_output():
    return {
        ...
        "feature_importance_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/feature_importance.parquet",
        "permutation_importance_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/permutation_importance.parquet",
        "metrics_json": {
            ...
            "overfitting_diagnostics_report_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/overfitting_diagnostics_report.json",
            "automl_feature_search_status": "passed",
            "automl_feature_search_report_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/automl_feature_search_report.json",
            "automl_selected_feature_count": 3,
            "automl_factor_ranking_status": "passed",
            "automl_factor_ranking_report_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/automl_factor_ranking_report.json",
            "automl_ranked_factor_count": 3,
            "feature_reproducibility_hash": "sha256:test-feature-set",
            "rule_candidate_backtest_status": "passed",
            "rule_candidate_backtest_report_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/rule-candidates/backtest/rule_candidate_backtest_report.json",
            "rule_candidate_review_tasks_uri": "data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/rule-candidates/backtest/rule_candidate_backtest_review_tasks.json",
            "rule_library_writeback_status": "blocked_pending_human_review_and_policy_governance_approval",
        },
        "evidence_refs": [
            "model_retraining_jobs:job_1",
            "model_feature_importance:data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/feature_importance.parquet",
            "model_permutation_importance:data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/permutation_importance.parquet",
            "automl_factor_rankings:data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/automl_factor_ranking_report.json",
            "model_overfitting_diagnostics:data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/overfitting_diagnostics_report.json",
            "rule_candidate_backtests:data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/rule-candidates/backtest/rule_candidate_backtest_report.json",
            "rule_candidate_review_tasks:data/model-artifacts/baseline_fwa/0.1.0-candidate-job_1/rule-candidates/backtest/rule_candidate_backtest_review_tasks.json",
        ],
