...
def validate_provider_output(output):
    ...
    required_metrics = [
        ...
        "overfitting_diagnostics_report_uri",
        "automl_feature_search_status",
        "automl_feature_search_report_uri",
        "automl_selected_feature_count",
        "automl_factor_ranking_status",
        "automl_factor_ranking_report_uri",
        "automl_ranked_factor_count",
