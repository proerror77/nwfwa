...
CAPABILITIES = [
    ...
    },
    {
        ...
        "required_text": [
            ...
            ("apps/worker/src/worker_data_pipeline_execution.rs", "evidence_refs"),
            ("apps/worker/src/worker_data_pipeline_execution.rs", "artifact_missing_evidence"),
            ("apps/api-server/src/routes/ops_datasets/validation.rs", "dependency_not_completed"),
            ("apps/api-server/src/routes/ops_datasets/validation.rs", "artifact_missing_evidence"),
